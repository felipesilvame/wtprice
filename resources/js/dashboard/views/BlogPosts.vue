...
// First Row of Posts
const PostsListOne = [{
  backgroundImage: require('@/dashboard/assets/images/content-management/1.jpeg'),
  category: 'Business',
  categoryTheme: 'dark',
  author: 'Anna Kunis',
  authorAvatar: require('@/dashboard/assets/images/avatars/1.jpg'),
  ...
  backgroundImage: require('@/dashboard/assets/images/content-management/2.jpeg'),
  category: 'Travel',
  categoryTheme: 'info',
  author: 'James Jamerson',
  authorAvatar: require('@/dashboard/assets/images/avatars/2.jpg'),
  ...
  backgroundImage: require('@/dashboard/assets/images/content-management/3.jpeg'),
  category: 'Technology',
  ...
  backgroundImage: require('@/dashboard/assets/images/content-management/4.jpeg'),
  category: 'Business',
  categoryTheme: 'warning',
  author: 'John James',
  authorAvatar: require('@/dashboard/assets/images/avatars/3.jpg'),
  ...
  // Second Row of posts
const PostsListTwo = [{
  backgroundImage: require('@/dashboard/assets/images/content-management/5.jpeg'),
  category: 'Travel',
  categoryTheme: 'info',
  author: 'Anna Ken',
  authorAvatar: require('@/dashboard/assets/images/avatars/0.jpg'),
  ...
  backgroundImage: require('@/dashboard/assets/images/content-management/6.jpeg'),
  category: 'Business',
  categoryTheme: 'dark',
  author: 'John James',
  authorAvatar: require('@/dashboard/assets/images/avatars/1.jpg'),
...
const PostsListFour = [{
  backgroundImage: require('@/dashboard/assets/images/content-management/7.jpeg'),
  ...
  backgroundImage: require('@/dashboard/assets/images/content-management/8.jpeg'),
  author: 'Chris Jamie',
  authorUrl: '#',
  category: 'News',
  categoryUrl: '#',
  ...
  backgroundImage: require('@/dashboard/assets/images/content-management/9.jpeg'),
  ...
  backgroundImage: require('@/dashboard/assets/images/content-management/10.jpeg'),
  author: 'Monica Jordan',
  authorUrl: '#',
  category: 'News',
  categoryUrl: '#',
